...
var config = {
  ...
  vendor: {
    js: [
      ...
      './bower_components/videojs-playlist/dist/videojs-playlist.js'
    ],
...
gulp.task('js', function() {console.log('env:'+config.environment);
    streamqueue({ objectMode: true },
      gulp.src(config.vendor.js),
      gulp.src('./src/js/**/*.js').pipe(ngFilesort()),
      gulp.src('./configs/'+config.environment+'.js'),
      gulp.src(['src/templates/**/*.html']).pipe(templateCache({ module: 'HomeKClient' }))
    )
